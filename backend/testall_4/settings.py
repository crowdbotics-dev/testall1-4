"""
Django settings for testall_4 project.
...
WSGI_APPLICATION = 'testall_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testall_4 API",
    "DESCRIPTION": "API documentation for testall_4 App",
    "VERSION": "v1",
}
